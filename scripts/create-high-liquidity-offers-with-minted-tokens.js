/**
 * Create high-liquidity offers at 88.7 rate using minted tokens
 */
...
// Freighter wallet (has the minted tokens)
...
async function main() {
  ...
  const highLiquidityAmount = 100000; // Use 100k from the 200k minted
  ...
  try {
    ...
    // Check balances
    console.log('💰 Checking Freighter balances...');
